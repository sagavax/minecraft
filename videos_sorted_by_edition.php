<?php include "includes/dbconnect.php";
      ...
      $edition = $_GET['sort_by'];

       $get_videos_by_edition = "SELECT * from videos where edition = '$edition' ORDER BY video_id DESC";
      //echo $get_videos_by_edition;
   

      $result=mysqli_query($link, $get_videos_by_edition);
