...
parentElement.addEventListener("keydown", function(event) {
    ...
    closeVideoTagsButton.addEventListener("click", function() {
        //console.log(closeButton);
        document.querySelector(".modal_video_tags").close();
    });

    closeVideoCategoryButton.addEventListener("click", function() {
        //console.log(closeButton);
        document.querySelector(".modal_video_category").close();
    });
