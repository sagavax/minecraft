...
function TagAutocomplete(tag) {
    ...
    // Create a Set to store unique tag names (efficiently handles duplicates)
    const uniqueTags = new Set();
  
    // Clear the list before making a new request
    list.innerHTML = "";
    ...
    xhttp.onload = function() {
      ...
      jsonData.forEach(function(currentTag) {
        ...
        // Check if tag name is unique before adding (debug this line)
       
          console.log(tagName); // Log for debugging
