<?php include "includes/dbconnect.php";
      ...
      if($source == "vanilla"){
            $get_videos_by_modif ="SELECT * from videos WHERE modpack_id=99 ORDER BY video_id DESC";
      }elseif($source =="modded"){
            $get_videos_by_modif = "SELECT * from videos WHERE modpack_id NOT IN (99) ORDER BY video_id DESC";
            
     }elseif($source=="all"){
        $get_videos_by_modif = "SELECT * from videos ORDER BY video_id DESC";
      }
