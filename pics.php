<?php include "includes/dbconnect.php";
      ...
      if(isset($_POST['add_new_pic'])){
          ...
          $file = $_FILES['picture']['tmp_name'];  //docasne meno
          ...
          //$picture_path=mysqli_real_escape_string($link, $_POST['picture_path']);
           $picture_size = filesize($_FILES['picture']['tmp_name']); //velkost obrazku
         ...
         move_uploaded_file($file, "$base_dir/$image_name");
          ...
          $sql="INSERT INTO pictures (picture_title,picture_name,picture_path,picture_size, eis_pic_id,cat_id ,modpack_id,added_date) VALUES ('$picture_title','$image_name','$picture_path',$picture_size,$eis_pic_id,$mod_id,$modpack,'$date')";
          //echo $sql;
              ...
              <?php
                     ...
                     while ($row = mysqli_fetch_array($result)) {
                       ...
                       echo "<div class='picture'>";
                                    ...
                                    echo "<div class='pic'><img src='/minecraft/uploads/$picture_name'></div>";
                                    ...
                                    echo "<div class='picture_action'><span><a href='picture_delete.php?id=$picture_id'>x</a></span></div>";
