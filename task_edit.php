        ...
        <div class="content">
            <div class='list'>
                <?php
                    ...
                    $sql="SELECT a.modpack_id,a.cat_id,a.eis_task_id, a.task_id, a.task_text,b.cat_name,c.modpack_name from to_do a, category b, modpacks c where a.cat_id=b.cat_id and a.modpack_id = c.modpack_id and a.task_id=$task_id";
                    //echo $sql;
                    $result=mysqli_query($link, $sql);
