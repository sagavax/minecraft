<?php include "includes/dbconnect.php";
      ...
      if($source == "videos_favorites"){
            $get_videos_fav_later ="SELECT * from videos WHERE is_favorite=1 ORDER BY video_id DESC";
      }elseif($source =="videos_watch_later"){
            $get_videos_fav_later = "SELECT * from videos WHERE watch_later=1 ORDER BY video_id DESC";
      }


        $result=mysqli_query($link, $get_videos_fav_later);
