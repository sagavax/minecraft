          ...
          <div class="list">
            <div class="add_new_image">
                ...
                <div class="gallery_view_tabs">
                    ...
                    <button type="button" class="button small_button gallery_tab" name="vanilla_galleries" title="Vanilla">Vanilla</button>
                    <button type="button" class="button small_button gallery_tab" name="reload_galleries" title="Reload gallery list">Reload</button>
                    <button type="button" class="button small_button gallery_tab" name="new_gallery" title="Add new gallery"><i class="fa fa-plus"></i></button>
                </div>
