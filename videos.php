                 ...
                 ?>
                    ...
                    <div class="video_tags_map_wrap">
                        ...
                        <div class="video_tags_map">
                         ...
                         <div class="tag_creation_action">
                            <input type="text" name="new_tag_name" placeholder="tag name ...." autocomplete="off">
                            <button type="button" class="button small_button" name="create_tag"><i class="fa fa-plus"></i> Create Tag</button></div>
                        <div class="tag_creation_notification"></div> 
                        </div><!-- video_tags_wrap -->    
        ...
        <dialog class="modal_new_tags">
            <div class="inner_layer">
                ...
                <div class="tags_list"><?php echo GetAllUnassignedVideosTags()?></div>
                 <div class="tag_creation_action"><button type="button" class="button small_button" name="create_tag"><i class="fa fa-plus"></i> Create Tag</button></div>
                 <div class="tag_creation_notification"></div> 
