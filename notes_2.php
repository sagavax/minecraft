...
<html lang="en">
  ...
  <?php include("includes/header.php") ?>
      ...
      <div class="tab_menu">
                                ...
                                echo "</div>";//notes footer
                                    ...
                                    $get_files = "SELECT * from notes_file_attachements WHERE note_id=$note_id";
                                      ...
                                      if(mysqli_num_rows($result_files)>0){
                                         ...
                                         echo "<i class='fas fa-file-image' title='$file_name' name='attached_image' file-name='$file_name'></i>";
                                          echo "<div class='context-menu' id='contextMenu'>";
                                              echo "<ul>";
                                                echo "<li>View image</li>";
                                                echo "<li>Delete image</li>";
                                               echo "</ul>";
                                            echo "</div>";
                                        echo "</div>"; // note_attached file
                                       } 
                                      }
                              echo "</div>";
        ...
        <dialog class="modal_image"></dialog>
    </body>
</html>    