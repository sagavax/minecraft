               ...
               <div id="letter_list"><!--letter list -->
                   <?php 
                        foreach (range('A', 'Z') as $char) {
                          echo "<button type='button' class='button blue_button rounded_button' name='letter'>$char</button>";

                        }
                          echo "<button type='button' class='button blue_button rounded_button' name='all''>All</button>";
                          echo "<button type='button' class='button blue_button rounded_button' name='dupes'>Find dupes</a></li>";
                          ?>  
