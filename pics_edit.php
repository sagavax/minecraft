<?php include "includes/dbconnect.php";
      ...
      if(isset($_POST['save_changes'])){
        ...
        $sql="UPDATE pictures SET picture_title='$picture_title', picture_description='$picture_description' where picture_id=$picture_id";
    ...
    <div class="content">
        <div class='list'>
            <div id="new_video">
                 ...
                 <?php 
                     $sql="select picture_title, picture_description from pictures where picture_id=".$_POST['picture_id'];
                     $result=mysqli_query($link, $sql) or die(mysqli_error($link)); 
                     $row = mysqli_fetch_array($result);

                  ?> 

                 <input type="text" name="picture_title" placeholder='picture title' autocomplete=off value="<?php echo $row['picture_title'] ?>">
                 

                 <textarea name="picture_description>"<?php echo $row['picture_description'] ?>></textarea>
               </form> 
            </div>
        </div><!--list-->    
    </div><!-- content -->  