    ...
    <div class="main_wrap">
        ...
        <div class="content">
            <div id="modpack_details_wrap">
                ...
                <div id="modpack_menu"><ul><li><a href="dashboard.php">Dashboard</a></li><li><a href="modpack.php?view=description">Description</a></li><li><a href="modpack.php?view=tasks">Tasks</a></li><li><a href="modpack.php?view=notes">Notes</a></li><li><a href="modpack.php?view=videos">Videos</a></li><li><a href="modpack.php?view=pictures">Pictures</a></li></ul></div>
                    ...
                    <?php
                     ...
                     //echo "<script>alert('".$modpack_id."')</script>";   
                      ...
                      elseif($action=="description"){
                        ...
                        echo "<div id='modpack_back_dash'><a href='dashboard.php' class='span_mod'>Back to dashboard</a></div>";
                       echo "<div>";
