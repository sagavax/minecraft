...
<div class="modpack_bases">
    <?php 
        ...
        if(mysqli_num_rows($result)==0){
             echo "<div class='no_base'><p>No bases found. would you like to create a new one?</p><button type='button' name='add_base' class='button small_button' title='Add the base'><i class='fa fa-plus'></i></button></div>";
             return;
         }
        ...
        echo "<div class='vanilla-base-card'><button type='button' name='add_base' class='button small_button' title='Add the base'><i class='fa fa-plus'></i></button></div>";
    ?>
</div><!-- modpasck bases -->
