<?php include "includes/dbconnect.php";
      ...
      if(isset($_POST['add_new_video'])){
        ...
        if(isset($_POST['add_to_favorites'])){
          ...
          $link1=mysqli_connect("localhost", "root", "", "brick_wall");
          $curr_date=date('Y-m-d H:i:s');
          $diary_text="Minecraft IS: video s nazvom <strong>$video_name</strong> bolo pridane medzi oblubene videa";
          $sql="INSERT INTO diary (diary_text, date_added,location,isMobile,is_read) VALUES ('$diary_text','$curr_date','',0,0)";
          $result = mysqli_query($link1, $sql) or die("MySQLi ERROR: ".mysqli_error($link1));
          mysqli_close($link1);
        ...
        if(isset($_POST['remove_from_favorites'])){
          ...
          $link1=mysqli_connect("localhost", "root", "", "brick_wall");
          $curr_date=date('Y-m-d H:i:s');
          $diary_text="Minecraft IS: video s nazvom <strong>$video_name</strong> vyaradene z oblubenych videi";
          $sql="INSERT INTO diary (diary_text, date_added,location,isMobile,is_read) VALUES ('$diary_text','$curr_date','',0,0)";
          $result = mysqli_query($link1, $sql) or die("MySQLi ERROR: ".mysqli_error($link1));
          mysqli_close($link1);
        ...
        if(isset($_POST['add_see_later'])){
          ...
          $link1=mysqli_connect("localhost", "root", "", "brick_wall");
          $curr_date=date('Y-m-d H:i:s');
          $diary_text="Minecraft IS: video s nazvom <strong>$video_name</strong> bolo zaradene medzi Pozriem neskor videa";
          $sql="INSERT INTO diary (diary_text, date_added,location,isMobile,is_read) VALUES ('$diary_text','$curr_date','',0,0)";
          $result = mysqli_query($link1, $sql) or die("MySQLi ERROR: ".mysqli_error($link1));
          mysqli_close($link1);
        ...
        if(isset($_POST['remove_from_see_later'])){
          ...
          $link1=mysqli_connect("localhost", "root", "", "brick_wall");
          $curr_date=date('Y-m-d H:i:s');
          $diary_text="Minecraft IS: video s nazvom <strong>$video_name</strong> bolo vyradene z Pozriem neskor videa";
          $sql="INSERT INTO diary (diary_text, date_added,location,isMobile,is_read) VALUES ('$diary_text','$curr_date','',0,0)";
          $result = mysqli_query($link1, $sql) or die("MySQLi ERROR: ".mysqli_error($link1));
          mysqli_close($link1);
          ...
          <div class='list'>
            ...
            <div id="video_list">
                ...
                <?php
                    ...
                    $sql="SELECT video_id, video_title, eis_video_id, video_url, cat_id, modpack_id, is_favorite,see_later from videos a ORDER BY video_id DESC";
                    }
                    //echo $sql;
                    $result=mysqli_query($link, $sql);
                        while ($row = mysqli_fetch_array($result)) {
                          ...
                          $see_later=$row['see_later'];
                            ...
                            echo "<div class='video'>";
                                    ...
                                    if($see_later==0) {
                                      echo "<button name='add_see_later' class='button app_badge'><i class='far fa-clock'></i></button>";
                                    } else {
                                      echo "<button name='remove_from_see_later' class='button app_badge'><i class='fas fa-clock'></i></button>";
                                    }

                                    if($is_favorite==0) {
                                      echo "<button name='add_to_favorites' class='button app_badge'><i class='far fa-star'></i></button>";
                                    } else {
                                      echo "<button name='remove_from_favorites' class='button app_badge'><i class='fas fa-star'></i></button>";
                                    }
