...
<html lang="en">
  ...
  <?php 
      echo "<script>sessionStorage.setItem('current_module','videos')</script>";
          ...
          <div class='list'>
            ...
            <div id="new_video">
             ...
             <form action="videos_save.php" enctype="multipart/form-data" method="post">    
                <input type=hidden name="modpack_id" value=<?php if(isset($_GET['modpack_id'])){echo $_GET['modpack_id'];}else{echo 0;} ?>>
                  ...
                  <input type="text" name="video_title" placeholder='Video title' autocomplete=off id="video_title" readonly ondblclick="remove_readonly(this)" onblur="set_readonly(this)" >
               ...
               <!--  <div class="videos_radio_buttons">
                   <i class="fab fa-youtube"><input type="radio" name="video_source" value="YouTube" id="source_youtube" checked><label for="source_youtube">Youtube</label></i>
                   <i class="fab fa-tiktok"><input type="radio" name="video_source" value="Tiktok" id="source_tiktok"><label for="source_tiktok">Tiktok</label></i>
                   <i class="fab fa-pinterest"><input type="radio" name="video_source" value="Pinterest" id="source_pinterest"><label for="source_pinterest">Pinterest</label></i>
                </div> -->
            ...
            <div id="videos_wrap">
              <div class="search_wrap">
                <input type="text" name="search" onkeyup="search_the_video(this.value);" id="search_string" autocomplete="off" placeholder="search videos here"><button type="button" title="clear search" class="button small_button clear_button tooltip>"><i class="fa fa-times"></i></button>
              </div><!-- Search wrap-->
              ...
              <div class="tab_view_fav_later">
                ...
                <button type="button" name="videos_watch_later" class="button small_button">Watch later</button>
              </div>
              ...
              <div class="tab_view_export">
                <button typpe="button" name="eport_to_cvs" class="button small_button" title='export all videos'><i class="fas fa-file-export"></i></button>
                <button typpe="button" name="eport_farms_cvs" class="button small_button" title='Export farms'><i class="fas fa-file-export"></i></button>
              </div>
            </div><!-- wrap -->
