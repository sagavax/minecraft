    ...
    <div class="content">
        ...
        <div class="insert_new_image">
          ...
          <div id="new_image">
              ...
              <form action="" enctype="multipart/form-data" method="post" id="upload_external_image" onsubmit="return check_url();">    
                <input type=hidden name="modpack_id" value=<?php if(isset($_GET['modpack_id'])){echo $_GET['modpack_id'];}else{echo 0;} ?>>
                <input type="hidden" name="<?php echo ini_get('session.upload_progress.name'); ?>" value="test" />
                <input type="text" name="picture_title" placeholder='picture title' autocomplete=off>
                <input type="text" name="picture_url" placeholder="image url" autocomplete="off" id="image_url">
                <textarea name="picture_description" placeholder="something about..."></textarea>
                      ...
                      while (false !== ($entry = readdir($handle))) {
                          ...
                          if ($entry != "." && $entry != "..") {
                              ...
                              if($nr_pics==0) {//subor nie je v databaze 
                                ...
                                $sql="INSERT INTO pictures (picture_title,picture_name,picture_path,picture_ext, picture_size,cat_id ,modpack_id,added_date) VALUES ('$picture_title','$entry','$entry','$ext',$picture_size,$mod_id,$modpack_id,'$date')";
                                $result=mysqli_query($link, $sql) or die(mysqli_error($link));
                                //
                              }
                          }
