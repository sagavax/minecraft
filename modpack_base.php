            ...
            <div class="list">
                <div class="base">
                    <?php 
                        ...
                        $sql="SELECT * from modpack_bases where base_id=$base_id and modpack_id = $modpack_id";
                    ...
                    <div class="base_location">
                        <div id="base_outworld_location"><h4>Base location:</h4>
                            <div class="base_coord_wrap">
                                <div class="base_coord" ><span>X:</span><input type="number" placeholder="X" value="<?php echo $row['coord_x']; ?>" name="outworld_z" autocomplete="off"></div>
                                <div class="base_coord"><span>Y:</span><input type="number" placeholder="Y" value="<?php echo $row['coord_y']; ?>" name="outworld_z" autocompletee="off"></div>
                                <div class="base_coord"><span>Z:</span><input type="number" placeholder="Z" value="<?php echo $row['coord_z']; ?>" name="outworld_z" autocomplete="off"></div>
                                </div>
